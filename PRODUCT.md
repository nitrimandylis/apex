...
- **History** — full archive: 2026 wins, most world titles, most constructors' titles, all-time race wins (archive + current season merged live), every drivers' champion since 1950, every constructors' champion since 1958. Archive is a committed artifact from `scripts/build-history.ts`; rerun it when a season ends.
